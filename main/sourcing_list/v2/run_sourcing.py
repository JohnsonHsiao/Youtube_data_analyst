...
def website_ready(): # 把網頁準備好，並輸入固定參數（語言、地區）
	options = Options()
	chromedriver_path = "/Users/chouwilliam/api-data-download/main/sourcing_list/v2/chromedriver.exe"
...
# create file
os.makedirs(PROJECT_PATH + '/data_center/public_stats/sourcing_channel', exist_ok=True)
output_df.to_csv(PROJECT_PATH + '/data_center/public_stats/sourcing_channel/sourcing_channel.csv', encoding = "utf-8", index = False)
print(output_df)
print("Finished")